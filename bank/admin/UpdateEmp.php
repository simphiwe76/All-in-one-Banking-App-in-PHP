...
<html lang="en">
  ...
  <section id="container" >
      ...
      if (isset($_GET['type']))
      {
        ...
        if ($_GET['type'] == "update")
        {
          ...
          if (mysqli_num_rows($result) == 1)
          {
            ...
            $emp_Number = $return['emp_Number'];
            $emp_Name = $return['emp_Name'];
            $emp_Surname = $return['emp_Surname'];
            $emp_Email = $return['emp_Email'];
            $emp_Address = $return['emp_Address'];
     ...
     <?php endif ?>
      <form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="UpdateEmp.php" method="post">
    <div class="form-inner">
          <div class="form-group">
            <div class="col-md-4">
              <label for="first_name" class="control-label">Employee Number</label>
              <i class="fa fa-sort-numeric-desc" aria-hidden="true"></i>
              <input type="text" name="empNum" value= "<?php echo $emp_Number;  ?>" class="form-control" readonly id="first_name" placeholder="">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-4">
              ...
              <input type="text" name="name" value= "<?php echo $emp_Name;  ?>" class="form-control" readonly id="first_name" placeholder="">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-4">
              ...
              <i class="fa fa-user" aria-hidden="true"></i>
              <input type="text" value= "<?php echo $emp_Surname;  ?>" name="surname"class="form-control" readonly id="first_name" placeholder="">
            </div>
          ...
          <div class="form-group">
            <div class="col-md-4">
              ...
              <input type="email" value= "<?php echo $emp_Email;  ?>" name="email" class="form-control" id="email" placeholder="">
            </div>
          ...
          <div class="form-group">
            <div class="col-md-4">
              ...
              <input type="text" value= "<?php echo $emp_Address; ?>" name="address" class="form-control" id="first_name" placeholder="">
            </div>
          ...
          <div class="form-group">
            <div class="col-md-12">
              <label><input type="checkbox">I agree to  <a  data-toggle="modal" data-target="#templatemo_modal">Change</a> The <a >Employee Details</a></label>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-12">
  ...
  <?php
        ...
        if (isset($_POST['updateE'])&&isset($emp_ID)&&isset($emp_Number)&&$level == 3 && $stu == "yes")
        {
                    ...
                    $sql = "SELECT* From employee where emp_Number = '$empID'";
                    $result = mysqli_query($conn,$sql);
                                    ...
                                    if (!empty($address))
                                    {
                                            if (preg_match("/^[a-z,A-Z0-9\s]+$/",$address))
                                            {
                                                                        ...
                                                                        if (!empty($pwdC))
                                                                        {
                                                                                if ($pwdC == $pwd)
                                                                                {
                                                                                         ...
                                                                                         $result = @mail($to, $subject, $message, $headers);
                                                                                          ...
                                                                                          $_SESSION['message'] = "Employee Profile Successfully updated";
                                                                                          $_SESSION['msg_type'] = "success";
                                                                                          echo "<script>location.replace('UpdateEmp.php?type=update&id=".$idE."');</script>";
                                                                                          exit();
                                                       ...
                                                       else
                                                       {
                                                                  ...
                                                                  $sql = "UPDATE employee SET emp_Email = '$email',emp_Address = '$address' WHERE emp_ID = '$idE';";
                                                                  mysqli_query($conn,$sql);
